...
class BackupController extends Controller {
	...
	public function dumpData(Request $request){
		...
		// $old_entry_ids = DB::table('cloakroom_entries_backup')->where('is_backup',0)->take(50)->pluck('id')->toArray();
		...
		// 	DB::table('cloakroom_entries')->where('id',$new_entry->id)->update(['old_id'=>$old_id]);
