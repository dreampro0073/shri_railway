...
class DailyEntry extends Model
{
    ...
    public static function canteenItemsDrop($client_id = 0){
        $canteen_items = DB::table("canteen_items")->select("id as value","item_name as label")->where("client_id",$client_id)->get();

        return $canteen_items;
    }
    public static function canteenItemList($client_id = 0){
        $canteen_items = DB::table("canteen_items")->where('client_id',$client_id)->get();
