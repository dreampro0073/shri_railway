  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="copyright">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">Aadhyasri Web Solutions &#8482;</strong> <span>All Rights Reserved</span></p>
          </div>
        </div>
        <div class="col-lg-6">
          ...
          <div class="credits">
            ...
            Designed by <a href="aadhyasriwebsolutions.com" target="_black">aadhyasriwebsolutions.com</a>
          </div>
        </div>
      </div>
    </div>
